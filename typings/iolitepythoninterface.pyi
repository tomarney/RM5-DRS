...
class LogPyInterface:
    # Logging methods. Use these with "IoLog", e.g. IoLog.information("my message")
    def saveLogToFile(self, fileName: str) -> None: ...
    @overload
    def information(self, message: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def informationWithOrigin(self, message: str, origin: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def debug(self, message: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def debugWithOrigin(self, message: str, origin: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def warning(self, message: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def warningWithOrigin(self, message: str, origin: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def error(self, message: str, time: Optional[datetime] = None) -> None: ...
    @overload
    def errorWithOrigin(self, message: str, origin: str, time: Optional[datetime] = None) -> None: ...
    def clear(self) -> None: ... # Clear all log entries
...
IoLog: LogPyInterface
drs: DRSPyInterface
qaqc: QAQCPyInterface